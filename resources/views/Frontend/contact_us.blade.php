...
<div class="flex justify-center items-center  mx-auto bg-gray-100">
    <form action="/sendData" class="w-full md:w-3/4 lg:w-3/6 p-4">
      <div class="p-3">
      ...
      <div class="p-3">
        <textarea class="resize-none border rounded-md block appearance-none placeholder-gray-500 placeholder-opacity-100 border border-light-blue-400 rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-light-blue-300 h-56" placeholder="Description" required></textarea>
      </div>
      <div class="p-3 pt-4">
